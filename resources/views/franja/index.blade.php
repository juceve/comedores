                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="{{ route('franjas.destroy',$franja->id) }}" method="POST">
                                                    <a class="btn btn-sm btn-primary " href="{{ route('franjas.show',$franja->id) }}"><i class="fa fa-fw fa-eye"></i> Ver</a>
                                                    <a class="btn btn-sm btn-success" href="{{ route('franjas.edit',$franja->id) }}"><i class="fa fa-fw fa-edit"></i> Editar</a>
                                                    @csrf
                                                    @method('DELETE')
