<div class="box box-info padding-1">
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            {{ Form::text('franja_id', $reserva->franja_id, ['class' => 'form-control' . ($errors->has('franja_id') ? ' is-invalid' : ''), 'placeholder' => 'Franja Id']) }}
            {!! $errors->first('franja_id', '<div class="invalid-feedback">:message</div>') !!}
        </div>
        <div class="form-group">
            {{ Form::label('user_id') }}
            {{ Form::text('user_id', $reserva->user_id, ['class' => 'form-control' . ($errors->has('user_id') ? ' is-invalid' : ''), 'placeholder' => 'User Id']) }}
